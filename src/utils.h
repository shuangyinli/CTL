...
namespace util {
    ...
    double random_from_gamma(const double &alpha);
    void random_from_dirichlet(double *from, double *sample, const int &size);
    void get_matrix_inverse(double* in_matrix, double* out_matrix, const int &length, const int &height);
}
